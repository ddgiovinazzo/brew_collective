...
ActiveRecord::Schema.define(version: 2021_01_27_005048) do
  ...
  create_table "check_ins", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["beer_id"], name: "index_check_ins_on_beer_id", unique: true
    t.index ["user_id"], name: "index_check_ins_on_user_id", unique: true
  end
